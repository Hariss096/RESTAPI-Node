            ...
            checks.forEach(function(check){
                ...
                _data.read('checks', check, function(err, originalCheckData){
                    if(!err && originalCheckData){
                        // Pass it to the check validator, and let that function continue to log errors as needed
...
workers.performCheck = function(originalCheckData) {
    ...
    // Bind to the error event as it doesn' get thrown
...
workers.processCheckOutcome = function(originalCheckData, checkOutcome){
    // Decide if the check is considered is up or down
...
// Alert the user as to a change to their status checks
